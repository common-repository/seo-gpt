(function($) {
	...
	$('#get_seo_gpt').click(function () {
        ...
        $.ajax({
            type: "POST",
            url: sgpt_ajax_url.url,
            data: "action=sgpt_get_content&nonce="+sgpt_ajax_url.nonce+"&post_id="+post_id+"&keyword="+keyword+"&brand="+brand+"&is_term="+is_term+"&plugin_priority="+plugin_priority+"&post_type="+post_type,
            dataType: 'json',
			 beforeSend: function() {
